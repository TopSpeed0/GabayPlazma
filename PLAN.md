...
## 14. ניתוח מתחרים (מחקר שוק)

> עדכון אחרון: 2026-05-02

### המתחרים העיקריים

| מתחרה | אתר | מודל | מחיר | חוזקות | חולשות |
|--------|------|------|------|--------|--------|
| **לוח ניסן** | [l-n.co.il](https://l-n.co.il) | תשלום חד-פעמי + מחשב | גבוה (חומרה+תוכנה) | 1,200+ לקוחות, רקעים לפי עדות, אוטומטי מלא | דורש מחשב משובץ, מחיר גבוה |
| **הצג החכם** | [cleversign.co.il](https://cleversign.co.il) | תשלום חד-פעמי + מחשב | גבוה | 20 דפים מעגל שנה, לוח הנצחה, חזון-שמים, שליחת זמנים למייל | דורש מחשב, עיצוב ישן |
| **משובץ** | [meshubatz.co.il](https://meshubatz.co.il) | תשלום חד-פעמי | גבוה | אפליקציה לטלפון, תוכנת גבאי-נט (חשבונאות+סליקה), ללא צורך במחשב | מסגרות פיזיות יקרות |
| **SmartBoard** | [smartboard.co.il](https://smartboard.co.il) | חד-פעמי | גבוה | לוח ממוחשב על מסך חכם | אתר למטה (522), ייתכן שסגרו |
| **GoMix** | [gomixapp.co.il](https://gomixapp.co.il) | SaaS | ? | גם באנגלית, פלטפורמת digital signage כללית | לא ספציפי לבתי כנסת |

### 🔑 תובנות מהמתחרים

#### פיצ'רים שחייבים (כולם מציעים):
- ✅ זמני תפילה אוטומטיים
- ✅ זמני היום בהלכה (הנץ, שקיעה, צאה"כ, ק"ש)
- ✅ פרשת השבוע
- ✅ לוח הנצחה / יארצייט — **חובה!** (כל המתחרים מדגישים את זה)
- ✅ הודעות בית כנסת
- ✅ שיעורי תורה

#### פיצ'רים שרק חלק מציעים (יתרון תחרותי):
- 🟡 **רקעים לפי עדה/חוג** (לוח ניסן) — אשכנזי, ספרדי, תימני, חב"ד
- 🟡 **מסגרות פיזיות** (משובץ) — מסגרת עץ/זכוכית מהודרת סביב המסך
- 🟡 **אפליקציית מתפללים** (משובץ) — הזמנים בטלפון, לא רק על המסך
- 🟡 **שליחת זמנים למייל** (הצג החכם) — אוטומטית לכל חברי הקהילה
- 🟡 **20 דפים מעגל שנה** (הצג החכם) — דפים שונים לכל חג/מועד
- 🟡 **תוכנת ניהול חשבונאית** (משובץ/גבאי-נט) — סליקה, תרומות, מקומות ישיבה

#### פיצ'רים שאף אחד לא מציע (הזדמנות שלנו!):
- 🔥 **SaaS בלי חומרה** — רק URL + TV stick (Chromecast/Fire Stick). הם כולם מוכרים חומרה!
- 🔥 **ענן מלא** — בלי מחשב משובץ, בלי התקנה, הכל בדפדפן
- 🔥 **מחיר נמוך** — SaaS חודשי במקום אלפי שקלים מראש
- 🔥 **WhatsApp/Telegram integration** — שליחת זמנים אוטומטית לקבוצות
- 🔥 **QR code על המסך** — מתפלל סורק → רואה זמנים בטלפון
- 🔥 **Multi-language** — עברית + אנגלית + צרפתית (קהילות בחו"ל)
- 🔥 **API פתוח** — לפיתוח אינטגרציות (Google Calendar, Apple Calendar)
- 🔥 **עיצוב מודרני** — כולם נראים "ישן" ו-2010. אנחנו Black Liquid Glass 🖤

### 💰 מודל עסקי — היתרון שלנו

| הם | אנחנו |
|----|--------|
| חד-פעמי 3,000-8,000₪ + מחשב + התקנה | SaaS 49-99₪/חודש, בלי חומרה |
| דורש טכנאי להתקנה | הגבאי מחבר TV stick ופותח URL |
| עדכון תוכנה = לקרוא לטכנאי | עדכון אוטומטי בענן |
| אם המחשב נשרף = הכל הלך | הכל בענן, מסך חדש = פותחים URL |

### 📱 פיצ'רים חדשים לתוכנית (מהמחקר)

#### להוסיף ל-MVP:
1. **לוח הנצחה / יארצייט** — חובה! כל המתחרים מדגישים. תאריכים עבריים, הצגה ביום היארצייט
2. **פרנס היום** — מי התורם/מי חוגג. מאוד נפוץ
3. **הלכה יומית** — משפט הלכתי קצר שמתחלף יומית

#### להוסיף ל-Phase 2:
4. **שליחת זמנים ל-WhatsApp/Telegram** — אוטומטי כל ערב שבת/חג
5. **QR code על המסך** — סריקה → זמנים בטלפון + הורדת אפליקציה
6. **דפי מעגל שנה** — עיצוב שונה לכל חג (חנוכה, פורים, פסח, סוכות, ימים נוראים)
7. **רקעים לפי עדה** — אשכנז, ספרד, תימן, חב"ד

#### להוסיף ל-Phase 3:
8. **אפליקציית מתפללים** (PWA) — הזמנים בטלפון, push notifications
9. **ניהול תרומות בסיסי** — סליקה + קבלות (אם רוצים להתחרות עם גבאי-נט)
10. **מסגרות וירטואליות** — עיצוב דיגיטלי של מסגרת מהודרת סביב המסך (במקום מסגרת פיזית)
